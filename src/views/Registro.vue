<template>
  <div class="auth-view">
    <div class="auth-card glass-card">
      <h1 class="auth-title">
        <UserPlus :size="28" class="auth-title-icon" /> Crear cuenta
      </h1>
      <p class="auth-lead">Registro simulado: los datos se guardan solo en tu navegador.</p>

      <form class="auth-form" @submit.prevent="onSubmit">
        <label class="auth-label" for="reg-nombre">Nombre</label>
        <input
          id="reg-nombre"
          v-model.trim="nombre"
          type="text"
