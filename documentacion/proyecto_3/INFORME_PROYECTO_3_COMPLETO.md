...
| `README.md` (raíz) | Vista mínima en GitHub; detalle en `documentacion/tecnico/README_DOCUMENTACION.md` (rutas, credenciales, Netlify, etc.). |
| `documentacion/tecnico/DEPLOY_NETLIFY.md` | Evidencia de **difusión** del portafolio vía hosting. |
| `scripts/extraer-rubrica-m7.ps1` | Genera copia mínima alineada a rúbrica en `documentacion/RUBRICA_M7_CONTENIDO/entrega/`. |
| `scripts/empaquetar-portafolio-m7.ps1` | Empaqueta el proyecto para entrega en ZIP (`documentacion/portafolio-m7/`). |
